...
title: "Навыки"
date: 2025-06-21
description: "Полный обзор инструментов, технологий и методологий, с которыми я работаю."
type: "page"
---
...
{{< skill name="Анализ памяти (стек/куча)" level="3" url="https://en.wikipedia.org/wiki/Memory_forensics" >}}  
{{< skill name="Методы защиты от эксплойтов (ASLR, DEP и др.)" level="3" url="https://en.wikipedia.org/wiki/Address_space_layout_randomization" >}}  
{{< skill name="Написание шеллкода" level="3" url="https://en.wikipedia.org/wiki/Shellcode" >}}  
...
{{< skill name="Раскрытие уязвимостей и процесс CVE" level="5" url="https://ru.wikipedia.org/wiki/Уязвимость_(информационная_безопасность)">}}  
{{< skill name="Фаззинг-тестирование / Фаззинг" level="4" url="https://ru.wikipedia.org/wiki/Фаззинг">}}  
{{< skill name="Усиление защиты веб-серверов/ОС (Hardening)" level="4" url="https://ru.wikipedia.org/wiki/Усиление_защиты" >}}  
...
{{< skill name="Безопасный анализ кода (Secure Code Review)" level="3" url="https://ru.wikipedia.org/wiki/Code_review">}}  
{{< skill name="Реагирование на инциденты" level="3" url="https://ru.wikipedia.org/wiki/Управление_инцидентами_информационной_безопасности">}}  
{{< skill name="Цифровая криминалистика" level="3" url="https://ru.wikipedia.org/wiki/Компьютерная_криминалистика">}}  
{{< skill name="Стратегия резервного копирования и восстановления" level="2" url="https://ru.wikipedia.org/wiki/Резервное_копирование" >}}  
{{< skill name="Криптографические примитивы (концептуально)" level="2" url="https://ru.wikipedia.org/wiki/Криптографический_примитив" >}}  

### OSINT и разведка
{{< skill name="Maltego" level="5" url="https://www.maltego.com/" >}}  
{{< skill name="Shodan" level="5" url="https://www.shodan.io/" >}}  
{{< skill name="OSINT (разведка по открытым источникам)" level="5" url="https://ru.wikipedia.org/wiki/Разведка_по_открытым_источникам">}}  
...
{{< skill name="Социальная инженерия" level="3" url="https://ru.wikipedia.org/wiki/Социальная_инженерия">}}  
{{< skill name="Фишинг" level="3" url="https://ru.wikipedia.org/wiki/Фишинг">}}  
{{< skill name="Взлом замков (Lockpicking)" level="1" url="https://ru.wikipedia.org/wiki/Вскрытие_замков" >}}  
...
{{< skill name="Управление PKI (OpenSSL)" level="4" url="https://www.openssl.org/" >}}  
{{< skill name="Администрирование GitLab (Self-Managed)" level="4" url="https://docs.gitlab.com/subscriptions/self_managed/" >}}  
...
{{< skill name="Проектирование высокой доступности и отказоустойчивости" level="4" url="https://ru.wikipedia.org/wiki/Высокая_доступность" >}}  
...
{{< skill name="Балансировка нагрузки L4 и L7" level="3" url="https://ru.wikipedia.org/wiki/Балансировка_нагрузки_(информатика)" >}}  
...
{{< skill name="Ассемблер (x86/x64)" level="2" url="https://ru.wikipedia.org/wiki/Язык_ассемблера" >}}  
...
{{< skill name="RESTful API" level="5" url="https://ru.wikipedia.org/wiki/REST" >}}  
{{< skill name="YAML" level="5" url="https://yaml.org" >}}  
{{< skill name="JSON" level="5" url="https://ru.wikipedia.org/wiki/JSON" >}}  
{{< skill name="XML" level="4" url="https://ru.wikipedia.org/wiki/XML" >}}  
...
{{< skill name="WebSockets" level="3" url="https://ru.wikipedia.org/wiki/WebSocket" >}}  
...
{{< skill name="Анализ прошивок (binwalk)" level="4" url="https://github.com/ReFirmLabs/binwalk" >}}  
{{< skill name="Кастомные прошивки роутеров (OpenWRT)" level="4" url="https://openwrt.org/" >}}  
{{< skill name="TWRP" level="3" url="https://www.twrp.me/" >}}  
{{< skill name="Proxmark3" level="3" url="https://proxmark.com/" >}}  
{{< skill name="Анализ NFC / RFID" level="3" url="https://ru.wikipedia.org/wiki/NFC" >}}  
{{< skill name="Кастомные прошивки клавиатур (QMK)" level="3" url="https://qmk.fm/" >}}  
{{< skill name="Эмуляция HID (Teensy)" level="3" url="https://www.pjrc.com/teensy/" >}}  
{{< skill name="Перехват RTL-SDR и BLE" level="2" url="https://www.rtl-sdr.com/">}}  
{{< skill name="I2C / SPI / UART" level="1" url="https://ru.wikipedia.org/wiki/Serial_Peripheral_Interface" >}}  

### Основные инструменты и утилиты
{{< skill name="Emacs & Org-mode" level="5" url="https://www.gnu.org/s/emacs/" >}}  
{{< skill name="Регулярные выражения (Regex)" level="5" url="https://ru.wikipedia.org/wiki/Регулярные_выражения" >}}  
...
{{< skill name="SSH (OpenSSH)" level="5" url="https://ru.wikipedia.org/wiki/SSH" >}}  
{{< skill name="JWT (JSON Web Tokens)" level="5" url="https://ru.wikipedia.org/wiki/JSON_Web_Token" >}}  
{{< skill name="OAuth 2.0 & OpenID Connect" level="5" url="https://ru.wikipedia.org/wiki/OAuth" >}}  
{{< skill name="SAML" level="4" url="https://ru.wikipedia.org/wiki/SAML" >}}  
{{< skill name="GPG / OpenPGP" level="4" url="https://gnupg.org/" >}}  
{{< skill name="LDAP" level="4" url="https://ru.wikipedia.org/wiki/LDAP" >}}  
{{< skill name="FIDO2 / WebAuthn" level="4" url="https://fidoalliance.org/fido2/" >}}  
{{< skill name="MFA (TOTP, U2F, Smart Cards)" level="4" url="https://ru.wikipedia.org/wiki/Многофакторная_аутентификация" >}}  
{{< skill name="Аппаратные токены безопасности (YubiKey)" level="4" url="https://ru.wikipedia.org/wiki/Аппаратный_модуль_безопасности" >}}  

### Сетевые протоколы и анализ
{{< skill name="Wireshark" level="5" url="https://www.wireshark.org/" >}}  
{{< skill name="IP (IPv4/IPv6)" level="5" url="https://ru.wikipedia.org/wiki/IP" >}}  
{{< skill name="TCP / UDP" level="5" url="https://ru.wikipedia.org/wiki/TCP" >}}  
{{< skill name="TLS / HTTPS" level="5" url="https://ru.wikipedia.org/wiki/HTTPS" >}}  
{{< skill name="DNS" level="5" url="https://ru.wikipedia.org/wiki/DNS" >}}  
{{< skill name="HTTP (1.1, 2, 3)" level="5" url="https://ru.wikipedia.org/wiki/HTTP" >}}  
{{< skill name="DHCP" level="4" url="https://ru.wikipedia.org/wiki/DHCP" >}}  
{{< skill name="WireGuard" level="4" url="https://www.wireguard.com/" >}}  
{{< skill name="tcpdump" level="4" url="https://www.tcpdump.org/" >}}  
{{< skill name="Netcat" level="4" url="https://ru.wikipedia.org/wiki/Netcat" >}}  
